...
resource "aws_cloudfront_response_headers_policy" "noindex" {
  ...
  security_headers_config {
    ...
    content_security_policy {
      override                = true
      content_security_policy = "script-src 'self' 'sha256-GJufcXs/Tqu72xGFOPOU1rGXRNfcis2/P93oruiDAWQ=' 'sha256-kfcSi2US+BvRum6J5XNvQjmy0afclHLzuBY2FYVzKMU=' 'sha256-AN/TTkrWvH4W7oCH0w79aph67vAli7rskVQ+0LFPnD4=' sha256-AN/TTkrWvH4W7oCH0w79aph67vAli7rskVQ+0LFPnD4=' 'sha256-FM5wgoZgD+IUY/B3phTcQwLPjMdoyegYYa9Lfsx8a0Q=' https://cdn.ons.gov.uk https://www.googletagmanager.com"
    }
    referrer_policy {
      override        = true
