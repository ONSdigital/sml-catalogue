...
type        = "zip"
source_file = "./dns/healthcheck/lambda_functions/healthcheck/healthcheck.py"
output_path = "./dns/healthcheck/lambda_functions/healthcheck/healthcheck.zip"
}

data "archive_file" "zip_the_python_alerter_lambda" {
type        = "zip"
source_file = "./dns/healthcheck/lambda_functions/alerter/alerter.py"
output_path = "./dns/healthcheck/lambda_functions/alerter/alerter.zip"
}
...
resource "aws_lambda_function" "healthcheck" {
  ...
  filename      = "./dns/healthcheck/lambda_functions/healthcheck/healthcheck.zip"
...
resource "aws_lambda_function" "alerter" {
  ...
  filename      = "./dns/healthcheck/lambda_functions/alerter/alerter.zip"
