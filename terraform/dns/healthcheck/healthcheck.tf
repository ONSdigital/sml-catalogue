...
type        = "zip"
source_file = "./terraform/lambda_functions/healthcheck/healthcheck.py"
output_path = "./terraform/lambda_functions/healthcheck/healthcheck.zip"
}

data "archive_file" "zip_the_python_alerter_lambda" {
type        = "zip"
source_file = "./terraform/lambda_functions/alerter/alerter.py"
output_path = "./terraform/lambda_functions/alerter/alerter.zip"
}
...
resource "aws_lambda_function" "healthcheck" {
  ...
  filename      = "./terraform/lambda_functions/healthcheck/healthcheck.zip"
...
resource "aws_lambda_function" "alerter" {
  ...
  filename      = "./terraform/lambda_functions/alerter/alerter.zip"
