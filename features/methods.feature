...
Feature: Methods catalogue tests
    ...
    Scenario: Methods catalgoue table header check
        Given I'm an sml portal user trying to get to the methods catalogue page
        When I navigate to the methods catalogue page
        Then The table headings of the methods catalogue table are "Name" "Theme" "Expert group" "Languages" "Access"

    Scenario: Ratio of Means table row check
        Given I'm an sml portal user trying to get to the methods catalogue page
        When I navigate to the methods catalogue page
        Then The table row of the method are "Ratio of Means" "Imputation" "Editing & Imputation" "Python/PySpark" "Internal"

    Scenario: Winsorisation table row check
        Given I'm an sml portal user trying to get to the methods catalogue page
        When I navigate to the methods catalogue page
        Then The table row of the method are "Winsorisation" "Sample Design & Estimation" "Sample Design & Estimation" "Python/PySpark" "Internal"

    Scenario: Thousand pound correction table row check
        Given I'm an sml portal user trying to get to the methods catalogue page
        When I navigate to the methods catalogue page
        Then The table row of the method are "Thousand Pound Correction" "Editing" "Editing & Imputation" "Python/Pandas" "Internal"

    Scenario: Horvitz-Thompson Ratio Estimator table row check
        Given I'm an sml portal user trying to get to the methods catalogue page
        When I navigate to the methods catalogue page
        Then The table row of the method are "Horvitz-Thompson Ratio Estimator" "Sample Design & Estimation" "Sample Design & Estimation" "Python/PySpark" "Internal"
    
    Scenario: Date adjustment table row check
        Given I'm an sml portal user trying to get to the methods catalogue page
        When I navigate to the methods catalogue page
        Then The table row of the method are "Date Adjustment" "Editing" "Editing & Imputation" "Python/Pandas" "Internal"
    
    Scenario: Selective editing table row check
        Given I'm an sml portal user trying to get to the methods catalogue page
        When I navigate to the methods catalogue page
        Then The table row of the method are "Selective Editing" "Editing" "Editing & Imputation" "Python/Pandas" "Internal"
