...
def lambda_handler(event, context):
    ...
    alert_message = {
        ...
        "Description": f"Website is unreachable or not returning the expected response. Check Amazon Cloudwatch Alarms '{alarm_name}' and Healthcheck Lambda '{lambda_name}'.",  # noqa: E501
    }
