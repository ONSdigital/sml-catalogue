{
  ...
  user_documentation_link: 'https://github.com/ONSdigital/sml-python-small/blob/main/docs/date_adjustment.md',
  description: |||
  ...
  |||,
  additional_info: |||
    Links to the method code and user documentation are provided for further reading.
  |||,
}
