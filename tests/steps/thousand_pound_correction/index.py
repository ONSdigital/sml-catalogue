# Step definitions for thousand pound correction page
...
@scenario('thousand_pound_correction.feature')
def test_publish():
    pass
...
def navigate_to_url():
    ...
    time.sleep(3)
    webbrowser.find_element_by_text('Thousand pound correction').click()
